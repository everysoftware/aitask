...
from wilde.cache.config import cache_settings
from wilde.cache.connection import redis_client
from wilde.cache.lifespan import ping_redis
from wilde.commands import BOT_COMMANDS
from wilde.di import setup_di
from wilde.routing import main_router
